    ...
    function Member({image, name, role}) {
       return(
        <div className="mobile:flex mobile:flex-row mobile:gap-x-4">
            ...
            <div>
                <h2 className="mt-4 text-[1.2rem] mobile:text-[1.4rem]">{name}</h2>
