...
export default function Hero() {
    ...
    return(
        <>
            <h1 className="text-[3.5rem] text-center w-[55rem] mx-auto leading-[4.6rem]">Creating websites that look <span className="bg-gradient-to-r from-[#EC512B] to-[#F5BF49] bg-clip-text 
            ...
            <div className="flex justify-center mt-[4rem] relative">
                ...
                <Image width={850} height={850} alt="Orange glow circle" src="/images/OrangeGlow.png"
                className="absolute bottom-[18rem] left-[-2rem] z-[-1]"></Image>

                <Image width={850} height={850} alt="Orange glow circle" src="/images/YellowGlow.png"
                className="absolute bottom-[25rem] right-[0rem] z-[-1]"></Image>
            </div>
        </>
    );
}