...
export default function Hero() {
    ...
    return(
        <>
            <h1 className="text-[3.6rem] tablet-s:text-[2.5rem] mobile:text-[2.2rem] mobile:leading-[3rem] tablet-s:px-[2rem] mobile-s:px-[1rem] tablet-s:leading-[3.5rem] text-center w-[58rem] tablet-s:w-auto mx-auto leading-[4.6rem] mt-[2rem]">We make websites that look <span className="bg-gradient-to-r from-[#EC512B] to-[#F5BF49] bg-clip-text 
            ...
            <p className="text-[1.2rem] tablet-s:text-[1.1rem] text-center w-[40rem] tablet-s:w-[85%] mobile-s:w-[90%] tablet-s:px-[2rem] mobile:px-0 mx-auto mt-[1rem] leading-8 opacity-50">{"It's more than words and images. It's about creating a digital presence where your brand’s values and stories come to life."}</p>
            ...
            <div className="flex justify-center mt-[4rem] relative">
                ...
                className="w-[75rem] tablet-s:w-[92%] h-auto z-[10]" src="/images/HeroProjects.png"></Image>
